                                ...
                                <table>
                                    ...
                                    <tbody>
										...
										if(isset($_SESSION['cart'])){
											...
											?>
											<tr>
												<td class="product-thumbnail"><a href="#"><img src="<?php echo "media/product/".$image?>"  /></a></td>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        <div class="buttons-cart">
                                            <a href="index.php"<?php echo SITE_PATH?>">Continue Shopping</a>
                                        </div>
                                        <div class="buttons-cart checkout--btn">
                                            <a href="checkout.php"<?php echo SITE_PATH?>checkout.php">checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
